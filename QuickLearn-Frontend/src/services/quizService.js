    ...
    <body>
      ...
      <div class="questions-container">
        ${quiz.questions.map((question, index) => {
          ...
          let formattedAnswer = '';
          if (questionType === 'enumeration' && Array.isArray(question.answer)) {
            formattedAnswer = question.answer.join(', ');
          } else if (question.answer !== null && question.answer !== undefined) {
            formattedAnswer = String(question.answer);
          } else {
            formattedAnswer = 'No answer provided';
          }
          ...
          <div class="question">
            ...
            <div class="answer">
              ...
              <div class="answer-value">${formattedAnswer}</div>
    ...
    <body>
      ...
      <div class="questions-section">
        ...
        ${quiz.questions.map((q, i) => {
          ...
          const correct = isAnswerCorrect(ua === 'Not answered' ? null : ua, q.answer, q.type || 'identification', q.question || '')
          return `
